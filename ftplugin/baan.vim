...
noremap <silent> <F4> 0i\|<ESC> :let @v="\|" . b:project . "." . "o"<CR>80A <ESC>65\|C<ESC>"vp:.ret!<CR><CR>
noremap <silent> <F5> 0i\|<ESC> :let @v="\|" . b:project . "." . "so"<CR>80A <ESC>65\|C<ESC>"vp:.ret!<CR><CR>
noremap <silent> <F6> 0i\|<ESC> :let @v="\|" . b:project . "." . "eo"<CR>80A <ESC>65\|C<ESC>"vp:.ret!<CR><CR>
